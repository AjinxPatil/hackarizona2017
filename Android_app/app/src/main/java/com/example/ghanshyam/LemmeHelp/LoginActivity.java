...
public class LoginActivity extends AppCompatActivity //implements LoaderCallbacks<Cursor>
{
 ...
 //   int i=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // initFacebookLogin();
        /*
        int colorFrom = (Color.argb(255,239, 215, 33));
        int colorTo = Color.argb(255,181, 140, 9);
        ...
        */
        ...
        accessTokenTracker = new AccessTokenTracker() {
            ...
            protected void onCurrentAccessTokenChanged(
                ...
                accessToken=currentAccessToken;
                if(accessToken!=null) {
                    Log.d("access token oncurrent", accessToken.getToken());
   ...
   /* @Override
    ...
    /*public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                finish();
                //getApplicationContext().startService(new Intent(LoginActivity.this,ReadSMS.class));
                startActivity(new Intent(LoginActivity.this,TransparentActivity.class));
